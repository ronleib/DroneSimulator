...
//    public int iz() {return (int)_z;}
    ...
    {
        double x1 = (p1._x - p2._x)*(p1._x - p2._x);
        double y1 = (p1._y - p2._y)*(p1._y - p2._y);
        return Math.sqrt(x1+y1);
    }
    public static double distance2(Point3D p1, double xxx,double yyy)
    {
        double x1 = (p1._x - xxx)*(p1._x - xxx);
        double y1 = (p1._y - yyy)*(p1._y - yyy);
        return Math.sqrt(x1+y1);
    }
